function App() {
  ...
  return (
    <>
      ...
      <p className="text-sm">A male born in 2001 in Purulia, WB, India.</p>
      ...
      <p className="text-sm">A fan of <a href="https://www.kkr.in/" className="text-blue-500">KKR</a> and <a href="https://www.fcbarcelona.com/" className="text-blue-500">FC Barcelona</a>. I believe Messi's the 🐐</p>
